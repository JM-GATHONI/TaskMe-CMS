...
const LeasesOverview: React.FC = () => {
    ...
    const modules = [
        { title: "Active Leases", icon: "leases", description: "View and manage current active lease agreements.", link: "#/general-operations/leases/active-leases", color: "#10b981" },
        { title: "Renewals", icon: "time", description: "Track expiring leases and process renewals.", link: "#/general-operations/leases/renewals", color: "#f59e0b" },
        { title: "Amendments", icon: "settings", description: "Modify terms of existing lease contracts.", link: "#/general-operations/leases/amendments", color: "#3b82f6" },
        { title: "Missing Leases", icon: "arrears", description: "Tenants without valid lease documentation.", link: "#/general-operations/leases/tenants-without-leases", color: "#ef4444" },
        { title: "Lease Documents", icon: "stack", description: "Digital vault for stored lease files.", link: "#/general-operations/leases/lease-documents", color: "#6366f1" },
        { title: "Templates", icon: "register", description: "Manage standard lease agreement templates.", link: "#/general-operations/leases/lease-templates", color: "#8b5cf6" },
        { title: "Terminations", icon: "offboarding", description: "Process move-outs and lease terminations.", link: "#/general-operations/leases/terminations", color: "#f97316" },
        { title: "E-Signature", icon: "check", description: "Track digital signature status.", link: "#/general-operations/leases/esignature", color: "#06b6d4" },
        { title: "Reporting", icon: "analytics", description: "Lease analytics and retention metrics.", link: "#/general-operations/leases/reporting", color: "#14b8a6" },
    ];
